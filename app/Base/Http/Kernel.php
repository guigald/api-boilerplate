...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        ...
        'apiJwt' => \App\Base\Http\Middleware\ApiProtectedRoute::class,
        'unauthenticated' => \App\Base\Http\Middleware\UnauthenticatedRoutes::class,
        'payment' => \App\Base\Http\Middleware\PaymentTranslate::class,
        'cleanPayload' => \App\Base\Http\Middleware\CleanPayload::class,
    ];
}
